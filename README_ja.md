...
- 個々のファイルまたはフォルダ全体から曲を追加
- 音楽ファイルをプレイリストに直接ドラッグ＆ドロップ
- タイトルまたはアーティストで検索
- プレイリストの表示を全曲、最近追加した曲、人気曲、お気に入りの間で切り替え
- プレイリストの保存と読み込み
- 再生速度、シャッフル、リピート、音量を調整
- 歌詞が利用可能な場合は表示
- イコライザー、コンプレッサー、リバーブ、ディレイなどのオーディオエフェクトを使用
- テーマ、言語、UIの透明度、プレイリストの位置をカスタマイズ
- アプリのアップデートを確認
- 現在再生中の曲をDiscordに表示
