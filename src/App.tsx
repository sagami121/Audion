  ...
  return (
    <>
      <div className="titlebar">
        ...
        <div className="titlebar-logo">▶ Audion</div>
      ...
      <div
        className={`app pl-${localStorage.getItem('af_settings') ? JSON.parse(localStorage.getItem('af_settings') || '{}').playlistPosition || 'left' : 'left'}`}
      >
        <aside className="sidebar" id="sidebar">
          <div className="sidebar-inner">
            ...
            <div className="pl-views">
              <button className="pl-view-btn active" data-view="all" data-i18n="view_all">
                すべて
              </button>
            ...
            <div className="playlist-hdr">
              <span className="lbl-sm" data-i18n="playlist">
                プレイリスト
              </span>
              <div className="playlist-hdr-actions">
                ...
                <button
                  ...
                  id="btnLoadPlaylist"
                  title="読み込み"
                  data-i18n-title="load"
                >
                  <svg width="12" height="12" viewBox="0 0 16 16" fill="none">
                    <path
                      d="M2 4a2 2 0 012-2h3l2 2h5a2 2 0 012 2v8a2 2 0 01-2 2H4a2 2 0 01-2-2V4z"
                      stroke="currentColor"
                      strokeWidth="1.4"
                    />
                ...
                <span className="playlist-count" id="playlistCount">
                  0 曲
                </span>
                <button
                  className="icon-btn-sm"
                  id="btnClearAll"
                  title="全て削除"
                  data-i18n-title="clear_all"
                >
                  <svg width="14" height="14" viewBox="0 0 14 14" fill="none">
                    <path
                      d="M2 3h10M5 3V2h4v1M11 3l-.7 8.3A1 1 0 019.3 12H4.7a1 1 0 01-1-.7L3 3"
                      stroke="currentColor"
                      strokeWidth="1.3"
                      strokeLinecap="round"
                    />
            ...
            <div className="drop-hint" id="dropHint">
              <div className="drop-hint-icon">
                <svg width="36" height="36" viewBox="0 0 36 36" fill="none">
                  ...
                  />
                  <path
                    d="M7 26a3 3 0 003 3h16a3 3 0 003-3"
                    stroke="url(#dhg)"
                    strokeWidth="2"
                    strokeLinecap="round"
                  />
        ...
        <main className="player">
          ...
          <div className="eq-overlay" id="eqOverlay">
            <div className="eq-header">
              <div className="eq-tabs">
                <button className="eq-tab-btn active" data-tab="eq" data-i18n="equalizer">
                  イコライザー
                </button>
                <button className="eq-tab-btn" data-tab="comp" data-i18n="compressor">
                  コンプレッサー
                </button>
                <button className="eq-tab-btn" data-tab="fx" data-i18n="fx">
                  エフェクト
                </button>
              </div>
              <div
              ...
              >
                ...
                >
                  ...
                  <span id="eqStatusText" style={{ fontSize: '11px', fontWeight: 600 }}>
                    OFF
                  </span>
                </label>
              </div>
            ...
            >
              ...
              >
                <span className="lbl-sm" data-i18n="presets">
                  プリセット
                </span>
                <select
                  id="eqPresetsSelect"
                  className="select-input"
                  style={{ flex: 1, padding: '4px 10px', fontSize: '11px' }}
                ></select>
              </div>
              ...
              <div className="comp-container" id="compContainer">
                <div className="comp-band">
                  ...
                  <input
                    ...
                    defaultValue="-24"
                  />
                  <span className="comp-val" id="valThreshold">
                    -24 dB
                  </span>
                </div>
                <div className="comp-band">
                  ...
                  <input
                    ...
                    defaultValue="30"
                  />
                  <span className="comp-val" id="valKnee">
                    30 dB
                  </span>
                </div>
                <div className="comp-band">
                  ...
                  <input
                    ...
                    defaultValue="12"
                  />
                  <span className="comp-val" id="valRatio">
                    12:1
                  </span>
                </div>
                <div className="comp-band">
                  ...
                  <input
                    ...
                    defaultValue="0.003"
                  />
                  <span className="comp-val" id="valAttack">
                    3 ms
                  </span>
                </div>
                <div className="comp-band">
                  ...
                  <input
                    ...
                    defaultValue="0.25"
                  />
                  <span className="comp-val" id="valRelease">
                    250 ms
                  </span>
                </div>
                <div className="comp-band">
                  ...
                  <input
                    ...
                    defaultValue="0"
                  />
                  <span className="comp-val" id="valMakeup">
                    0 dB
                  </span>
                </div>
              </div>
              ...
              <div className="fx-container">
                <div className="fx-group" id="reverbGroup">
                  <div className="fx-hdr">
                    <span className="lbl-sm" data-i18n="reverb">
                      リバーブ
                    </span>
                  ...
                  <div className="fx-controls">
                    ...
                    <div className="fx-row">
                      ...
                      >
                        <option value="room" data-i18n="room">
                          部屋
                        </option>
                        <option value="hall" data-i18n="hall">
                          ホール
                        </option>
                        <option value="cave" data-i18n="cave">
                          洞窟
                        </option>
                      </select>
                    </div>
                ...
                <div className="fx-group" id="delayGroup">
                  <div className="fx-hdr">
                    <span className="lbl-sm" data-i18n="delay">
                      ディレイ
                    </span>
          ...
          <div className="track-section">
            <div className="track-title-wrap" id="trackTitleWrap">
              <h1 className="track-title" id="trackTitle" data-i18n="select_track">
                曲を選択してください
              </h1>
            </div>
            <p className="track-sub" id="trackSub" data-i18n="welcome">
              Audion へようこそ
            </p>
          </div>

          <div className="progress-section">
            <span className="time-lbl" id="curTime">
              0:00
            </span>
            <div
              className="seeker"
          ...
          <div className="controls-section">
            <button
              ...
              id="shuffleBtn"
              title="シャッフル"
              data-i18n-title="shuffle"
            >
              <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
                <path
                  d="M2 5h3l7 10h5M17 5h-3l-2 2.5M13.5 12.5l1 1.5H17"
                  stroke="currentColor"
                  strokeWidth="1.6"
                  strokeLinecap="round"
                  strokeLinejoin="round"
            ...
            <button
              className="ctrl-icon ctrl-md"
              id="prevBtn"
              title="前の曲"
              data-i18n-title="prev"
            >
              <svg width="22" height="22" viewBox="0 0 22 22" fill="none">
                <path
                  d="M5 4v14M17 4L8 11l9 7V4z"
                  stroke="currentColor"
                  strokeWidth="1.8"
                  strokeLinecap="round"
                  strokeLinejoin="round"
            ...
            <button
              ...
              id="nextBtn"
              title="次の曲"
              data-i18n-title="next"
            >
              <svg width="22" height="22" viewBox="0 0 22 22" fill="none">
                <path
                  d="M17 4v14M5 4l9 7-9 7V4z"
                  stroke="currentColor"
                  strokeWidth="1.8"
                  strokeLinecap="round"
                  strokeLinejoin="round"
            ...
            <button className="ctrl-icon" id="repeatBtn" title="リピート" data-i18n-title="repeat">
              <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
                <path
                  d="M3 7V5a2 2 0 012-2h8l2 2M17 13v2a2 2 0 01-2 2H7l-2-2"
                  stroke="currentColor"
                  strokeWidth="1.6"
                  strokeLinecap="round"
                  strokeLinejoin="round"
              ...
              <span className="repeat-badge" id="repeatBadge" style={{ display: 'none' }}>
                1
              </span>
            </button>
          ...
          <div className="volume-section">
            <button className="ctrl-icon" id="muteBtn" title="ミュート" data-i18n-title="mute">
              <div id="volIcon">
                <svg width="18" height="18" viewBox="0 0 18 18" fill="none">
                  <path
                    d="M3 6.5H1.5A.5.5 0 001 7v4a.5.5 0 00.5.5H3l4 4v-13L3 6.5z"
                    fill="currentColor"
                  />
                  <path
                    d="M11 6a4 4 0 010 6M13.5 3.5a8 8 0 010 11"
                    stroke="currentColor"
                    strokeWidth="1.5"
                    strokeLinecap="round"
                  />
            ...
            >
              ...
              <div
                className="vol-thumb"
                id="volThumb"
                style={{ left: 'var(--init-vol, 0%)' }}
              ></div>
            </div>
            <span className="vol-lbl" id="volLbl">
              0%
            </span>
          </div>
          ...
          <div className="speed-ctrl">
            ...
            <input
              ...
              defaultValue="1.0"
            />
            <span className="speed-lbl" id="speedLbl">
              1.0x
            </span>
          </div>
        </main>
      ...
      <div className="drop-overlay" id="dropOverlay">
        <div className="drop-overlay-content">
          <svg width="64" height="64" viewBox="0 0 64 64" fill="none">
            ...
            />
            <path
              d="M14 50a4 4 0 004 4h28a4 4 0 004-4"
              stroke="url(#dog)"
              strokeWidth="3"
              strokeLinecap="round"
            />
      ...
      <div className="modal-overlay" id="settingsModal">
        <div className="modal-card settings-card">
          <div className="modal-hdr">
            ...
            <button className="modal-close" id="btnCloseSettings">
              &times;
            </button>
          </div>
          <div className="settings-layout">
            ...
            <div className="settings-content">
              ...
              <div className="settings-section" id="settings-appearance">
                <div className="setting-item">
                  ...
                  <p className="setting-hint" data-i18n="layout_mode_hint">
                    Classic keeps the previous centered player layout.
                  </p>
                </div>
                <div className="setting-divider"></div>
                <div className="setting-item">
                ...
                <div className="setting-item">
                  <label className="form-group">
                    <div className="opacity-row">
                      ...
                      <span className="opacity-lbl-val" id="opacityLbl">
                        40%
                      </span>
                    </div>
                    <input
              ...
              <div className="settings-section" id="settings-other">
                  ...
                  <label className="setting-lbl">
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '2px' }}>
                      ...
                      <span
                        ...
                        style={{ textAlign: 'left', marginTop: '0', fontSize: '10px' }}
                        data-i18n="setting_hw_accel_hint"
                      >
                ...
                <p
                  style={{ opacity: 0.6, fontSize: '11px', textAlign: 'center', padding: '20px 0' }}
                  data-i18n="auto_save_hint"
                >
                  ※設定は自動的に保存されます
                </p>
              </div>
                ...
                <div className="bug-layout">
                  ...
                  <div className="bug-content">
                    <div className="form-group">
                      <label htmlFor="bugTitle" data-i18n="bug_form_title">
                        件名
                      </label>
                      <input
                        type="text"
                        id="bugTitle"
                        placeholder="不具合の要約"
                        data-i18n-placeholder="bug_form_placeholder_title"
                        className="form-input"
                      />
                    </div>
                    <div className="form-group">
                      <label htmlFor="bugDesc" data-i18n="bug_form_desc">
                        詳細
                      </label>
                      <textarea
                        id="bugDesc"
                        placeholder="発生手順や期待される動作など..."
                        data-i18n-placeholder="bug_form_placeholder_desc"
                        className="form-input"
                        rows={6}
                        style={{ resize: 'none' }}
                      ></textarea>
                    ...
                    >
                      <p
                        className="setting-hint"
                        style={{ fontSize: '11px', opacity: 0.6, margin: 0 }}
                        data-i18n="bug_hint"
                      >
                        ※開発者に報告内容が送信されます
                      </p>
                ...
                <div style={{ textAlign: 'center', padding: '20px 0' }}>
                  <div style={{ marginBottom: '15px' }}>
                    <img
                      ...
                      width="64"
                      height="64"
                      style={{ borderRadius: '12px', boxShadow: '0 4px 12px rgba(0,0,0,0.3)' }}
                      alt="App Icon"
                    />
                  </div>
      ...
      <div className="modal-overlay" id="logModal">
        <div className="modal-card" style={{ maxWidth: '600px', width: '90%', height: '80%' }}>
          <div className="modal-hdr">
            ...
            <button className="modal-close" id="btnCloseLogs">
              &times;
            </button>
          </div>
      ...
      <div className="modal-overlay" id="releaseNotesModal">
        <div className="modal-card" style={{ maxWidth: '500px', width: '90%' }}>
          <div className="modal-hdr">
            ...
            <button className="modal-close" id="btnCloseReleaseNotes">
              &times;
            </button>
          </div>
          <div className="modal-body">
            ...
            ></div>
            <button className="btn-primary" id="btnReleaseNotesOk" style={{ width: '100%' }}>
              OK
            </button>
          </div>
        </div>
      ...
      <div className="update-toast" id="updateToast">
        ...
        <div className="update-toast-content">
          <div className="update-toast-title" data-i18n="update_available">
            アップデートがあります
          </div>
          <div className="update-toast-desc" data-i18n="update_desc">
            新機能と修正が含まれています
          </div>
          <div className="update-toast-actions">
            <button className="update-btn-now" id="btnUpdateNow" data-i18n="update_now">
              今すぐ更新
            </button>
            <button className="update-btn-later" id="btnUpdateLater" data-i18n="update_later">
              後で通知
            </button>
            <button
              className="update-btn-info"
              id="btnUpdateInfo"
              data-i18n-title="release_notes"
              title="更新内容"
            >
      ...
      <div className="context-menu" id="sidebarContextMenu">
        <div className="context-menu-label" data-i18n="pl_pos">
          再生リストの位置
        </div>
        <div className="context-menu-divider"></div>
